...
public abstract class AISense<Stimulus> : MonoBehaviour
{
    ...
    //On appelle de maniËre recurrente la gestion du sens.
    ...
    //A redefinir pour crÈer un nouveau sens
    //DÈtermine si on a percu quelquechose, et dans ce cas, en donne les paramËtres
    protected abstract bool doSense(Transform obj, ref Stimulus sti);

    //AppelÈe juste avant de checker tous les objets
    //Peut etre redÈfinie
    ...
    //A appeler depuis n'importe quel script qui veut s'abonner ÅEcet event
    ...
    //A appeler pour ajouter un objet ÅEtracker
